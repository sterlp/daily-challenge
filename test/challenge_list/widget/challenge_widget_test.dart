...
void main() {
  ...
  final i18n = ChallengeListLocalizations(const Locale('en'));
  ...
  testWidgets('Show failed challenge', (WidgetTester tester) async {
    ...
    expect(
      find.text(i18n.failedSince(commonI18n.formatDate(c.latestAt))),
      findsOneWidget,
    );
  ...
  testWidgets('Show done challenge', (WidgetTester tester) async {
    ...
    expect(
      find.text(i18n.doneAt(commonI18n.formatDate(c.doneAt))),
      findsOneWidget,
    );
