...
class _HistoryPageState extends FixedState<HistoryPage> {
  final ValueNotifier<List<HistoryChallengeOrBoughtReward>?> _data =
      ValueNotifier(null);
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<HistoryChallengeOrBoughtReward>?>(
      ...
      builder: (context, value, child) {
        if (value == null) return const LoadingWidget();
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final d = value[index];
            if (d.at != null &&
                (_lastMonth == null || _lastMonth != d.at!.month)) {
              ...
              return Column(children: [_listTitle(d)]);
            }
          },
        );
      },
