...
class _ChallengeListLocalizationDelegate
    extends AppLocalizationsDelegate<ChallengeListLocalizations> {
  const _ChallengeListLocalizationDelegate();
  @override
  ChallengeListLocalizations deLocale(Locale locale) =>
      ChallengeListLocalizationsDE(locale);
  @override
  ChallengeListLocalizations defaultLocale(Locale locale) =>
      ChallengeListLocalizations(locale);
}

class ChallengeListLocalizations {
  static const LocalizationsDelegate<ChallengeListLocalizations> delegate =
      _ChallengeListLocalizationDelegate();
  final Locale locale;
  ...
  String editChallengeHeader(bool create) =>
      create ? createChallengeHeader : updateChallengeHeader;

  IFormField get challengeName => const SimpleFormField(
    'Challenge Name',
    'What is your Challenge...?',
    'Enter a challenge name',
  );
  IFormField get challengeDueAt => const SimpleFormField(
    'Due at',
    'Then do you plan to do this Challenge?',
    'Enter due date',
  );
  IFormField get challengeLatestAt => const SimpleFormField(
    'Fail on',
    'When should the Challenge fail? You will lose points!',
  );
  IFormField get challengeReward => const SimpleFormField(
    'Reward',
    'How many points should be rewarded?',
    'Enter reward points',
    MyStyle.COST_ICON,
  );
...
class ChallengeListLocalizationsDE extends ChallengeListLocalizations {
  ChallengeListLocalizationsDE(super.locale);
  ...
  IFormField get challengeName => const SimpleFormField(
    ...
    'Gib einen Challenge-Namen ein',
  );
  @override
  IFormField get challengeDueAt => const SimpleFormField(
    'Fällig am',
    'Wann planst Du das zu tun?',
    'Gin ein Fälligkeitsdatum ein',
  );
  @override
  IFormField get challengeLatestAt => const SimpleFormField(
    'Fehlschlag am',
    'Wann soll die Challenge fehlschlagen? Du verlierst Punkte!',
  );
  @override
  IFormField get challengeReward => const SimpleFormField(
    'Punkte',
    'Wieviele Punkte bringt die Challenge?',
    'Gib an wieviele Punkte die Challenge wert ist',
    MyStyle.COST_ICON,
  );
